...
function bake(pieType, pieQuantity, recipe) {
...
function profit(totalCost, profitMargin, pieQuantity) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  profit(totalCost, profitMargin, pieQuantity);
}
